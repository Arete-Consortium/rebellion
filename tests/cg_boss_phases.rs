...
fn cg_boss_spawns_projectiles_during_boss_fight() {
    ...
    let _boss = spawn_test_cg_boss(
        &mut app.world_mut().commands(),
        CGBossType::FleetCommander.health(),
        0.79,
        0.8,
    );
    app.update(); // flush commands
...
fn cg_boss_damage_scales_with_difficulty() {
    ...
    let mut q = app
        .world_mut()
        .query::<&rebellion::entities::ProjectileDamage>();
