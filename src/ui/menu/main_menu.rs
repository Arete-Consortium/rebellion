...
pub(crate) fn spawn_main_menu(
    ...
    commands
        ...
        .with_children(|parent| {
            ...
            parent.spawn((
                Text::new("TWO CONFLICTS. FOUR FLEETS."),
                TextFont {
                    font_size: 20.0,
                    ..default()
                },
            ...
            parent.spawn((
                Text::new(menu_hint(&bindings, "Select", "Quit")),
                TextFont {
                    font_size: 14.0,
                    ..default()
                },
...
pub(crate) fn main_menu_input(
    ...
    if is_confirm(&keyboard, &joystick, &bindings) {
        match selection.index {
            0 => {
                itch_mode.enabled = false; // Chapter/faction/hull choice is the primary flow.
